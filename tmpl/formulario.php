...
<form id="microservicios-form">
    ...
    <fieldset>
        ...
        <input type="checkbox" id="microservicios-checkbox1" name="microservicios_checkboxes[]" value="checkbox1">
        <label for="microservicios-checkbox2">Checkbox 2</label>
        <input type="checkbox" id="microservicios-checkbox2" name="microservicios_checkboxes[]" value="checkbox2">
    </fieldset>

    <label for="microservicios-input">Input:</label>
    <input type="text" id="microservicios-input" name="microservicios_input">
